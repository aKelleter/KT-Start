...
$router->post('bookmark_folder_store',   [BookmarkController::class, 'folderStore']);
$router->post('bookmark_folder_rename',  [BookmarkController::class, 'folderRename']);
$router->post('bookmark_folder_delete',  [BookmarkController::class, 'folderDelete']);
$router->post('bookmark_explorer_reorder', [BookmarkController::class, 'explorerReorder']);
...
$router->post('bookmark_toggle_skip',      [BookmarkController::class, 'toggleCheckSkip']);
