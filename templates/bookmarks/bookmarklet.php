...
// Sélecteur de dossier — reconstruction hiérarchique selon la liste choisie
(function () {
    ...
    const allFolders = <?= json_encode(array_values($folders ?? []), JSON_UNESCAPED_UNICODE) ?>;
    ...
    function refreshFolders() {
        ...
        // Vider sauf la première option "— Racine —"
    ...
    refreshFolders(); // init avec la liste déjà sélectionnée
})();
...
(function () {
    ...
    if (!input) return;
    const tags = <?= json_encode($allTags ?? [], JSON_UNESCAPED_UNICODE) ?>;
